...
export const testData: Job[] = [
  {
    address: '913 Cobb Pkwy N Suite C',
    applicationDate: '4/17/25',
    contactPerson: 'Rob Latham',
    company: 'Call2Recycle',
    events: [
      {
        date: '4/17/25',
  ...
  },
  {
    ...
    applicationDate: '4/21/25',
    contactPerson: '',
    company: 'Aneesh Technologies Inc',
    events: [
      {
        date: '4/21/25',
        status: 'waiting-for-response',
    ...
    },
  {
    ...
    applicationDate: '4/21/25',
    contactPerson: 'staffrecruiting@polsinelli.com',
