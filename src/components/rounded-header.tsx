...
export const RoundedHeader = ({
  ...
  return (
    <div
      className={`shadow-t-md shadow-l-md shadow-r-md rounded-tl-lg rounded-tr-lg border-t border-r border-b border-l px-4 py-2 ${children ? 'flex justify-between' : ''} ${accentClasses}`}
    >
